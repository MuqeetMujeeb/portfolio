  ...
  skillDomains: [
    {
      ...
      rows: [
        { label: "LLMs", c: ["GPT-4o", "Claude", "LLaMA", "RAG", "Prompt Eng."], f: ["Mistral", "Fine-tuning"] },
        { label: "Agents", c: ["LangGraph", "LangChain", "CrewAI"], f: ["MCP"] },
        { label: "Voice", c: ["Deepgram", "Twilio", "STT/TTS", "WebSocket Audio"], f: ["Voice Cloning"] },
        { label: "Vectors", c: ["Weaviate", "Pinecone"], f: ["Qdrant", "Faiss"] },
      ],
    },
    {
      ...
      rows: [
        ...
        { label: "Vision", c: ["YOLOv8", "OpenCV", "Detection"], f: ["Segmentation"] },
    ...
    },
    {
      ...
      rows: [
        ...
        { label: "Infra", c: ["AWS EC2", "RDS", "Nginx"], f: ["Supabase", "S3", "Lambda"] },
        { label: "Track", c: ["MLflow", "Git"], f: ["DVC"] },
    ...
    },
    {
      ...
      rows: [
        { label: "Langs", c: ["Python", "SQL", "JavaScript", "Bash"], f: ["C++"] },
